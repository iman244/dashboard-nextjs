...
function Carousel({
  ...
  // Read straight from Embla, re-rendering on its own events, rather than
  // copying into state from an effect.
  ...
  // Arrow keys follow the reading direction: in RTL, "next" is to the left.
